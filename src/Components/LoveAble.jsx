        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          ...
          <div>
            <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
              <div className="cursor-pointer shadow-2xl hover:scale-105 hover:bg-gray-300 bg-white p-7 text-center space-y-2 rounded-xl">
            ...
            <div>
              ...
              <p className="mt-6 flex gap-1 items-center text-gray-600 text-lg">
                ...
                <span>
                  Connecting local gardeners to share knowledge and grow
                  together.
                </span>
              </p>
            </div>
